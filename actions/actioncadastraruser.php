...
if (empty($user)) {
    ...
    $_SESSION['resposta'] = 'Preencha o campo email!';
    header("Location: ../cadastroUser.php");
}
elseif (empty($password)) {
    ...
    $sql = "INSERT INTO pdv_usuarios VALUES (DEFAULT, :user, :password, :email, :perfil)";
    $params = [":user"=>$user, ":password"=>$password, ":email=>$email",":perfil"=>'padrão'];
    $conexao = new DAO();
